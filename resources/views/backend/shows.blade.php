        ...
        <div class="col-sm-12">
            <div class="card pb-3">
                <div class="card-header border-bottom d-flex justify-content-between align-items-center pb-3">
                    ...
                    <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                        ...
                        <i class="fa-solid fa-plus me-2"></i>Add Show
                    </button>
                </div>
                <div class="card-body">
            ...
            <div class="offcanvas offcanvas-end offcanvas-width-80" tabindex="-1" id="season-offcanvas"
                ...
                <div class="offcanvas-header">
                    <h5 id="offcanvasRightLabel1">Add New Show List</h5>
                        ...
                        <div class="section-form">
                            <fieldset>
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                            ...
                                            <!-- toggle switch -->
                                            <!-- common inputs -->
                                            <input id="Show Name" type="text" class="form-control " placeholder="Enter Show Name" value="" min=""
                                               multiple="" />
                                        </div>                                </div>
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                ...
                                <div class="row mt-3 px-5">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="form-label flex-grow-1" for="show"><strong>Language:</strong></label>
                                        <div class="form-group px-3">
                                            <select id="show" type="select" class="form-control">
            ...
            <div class="offcanvas offcanvas-end offcanvas-width-80" tabindex="-1" id="season-offcanvas-edit"
                aria-labelledby="season-offcanvas-lable">
                <div class="offcanvas-header">
                    <h5 id="offcanvasRightLabel1">Edit Show List</h5>
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                        aria-label="Close"></button>
                </div>
                <div class="offcanvas-body">
                                ...
                                <div class="row mt-3">
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                            ...
                                            <!-- toggle switch -->
                                            <!-- common inputs -->
                                            <input id="Show Name" type="text" class="form-control " placeholder="Enter Show Name" value="Day Of Darkness" min=""
                                               multiple="" />
                                        </div>                                </div>
                                    <div class="col-sm-12">
                                        <div class="form-group px-5 ">
                                ...
                                <div class="row mt-5">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group px-5 ">
                                            ...
                                            <!-- toggle switch -->
                                            <!-- common inputs -->
                                            <input id="Duration" type="text" class="form-control " placeholder="Duration in mins" value="45" min=""
                                               multiple="" />
                                        </div>                                </div>
                                </div>
                                <div class="col-lg-12 mt-4 px-5">
