...
<!-- Mirrored from templates.iqonic.design/streamit/html/dashboard/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 03 Dec 2023 13:53:27 GMT -->
<head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="{{url('backend/assets/css/core/libs.min.css')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/vendor/sheperd/dist/css/sheperd.css')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/vendor/flatpickr/dist/flatpickr.min.css')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/css/streamit.minf700.css?v=1.0.1')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/css/custom.minf700.css?v=1.0.1')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/css/dashboard-custom.minf700.css?v=1.0.1')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/css/dark.minf700.css?v=1.0.1')}}"/>
    <link rel="stylesheet" href="{{url('backend/assets/css/customizer.minf700.css?v=1.0.1')}}"/>
