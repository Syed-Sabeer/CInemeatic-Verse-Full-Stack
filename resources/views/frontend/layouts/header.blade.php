...
<head>
  ...
  <link rel="stylesheet" href="{{url('frontend/assets/css/streamit.mine209.css?v=1.0.0')}}" />
  <link rel="stylesheet" href="{{url('frontend/assets/css/custom.mine209.css?v=1.0.0')}}" />
  <link rel="stylesheet" href="{{url('frontend/assets/css/rtl.mine209.css?v=1.0.0')}}" />
  ...
  <link rel="stylesheet" href="{{url('frontend/assets/css/core/libs.min.css')}}" />
  <link rel="stylesheet" href="{{url('frontend/assets/vendor/font-awesome/css/all.min.css')}}" />
  <link rel="stylesheet" href="{{url('frontend/assets/vendor/iconly/css/style.css')}}" />
                  ...
                  <div class="d-flex gap-3 gap-xl-0 align-items-center">
                     ...
                     <div class="logo-default">
                         <a class="navbar-brand text-primary" href="../index.html">
                             <img class="img-fluid logo" src="{{url('frontend/assets/images/logo.html')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                     <div class="logo-hotstar">
                         <a class="navbar-brand text-primary" href="../index.html">
                             <img class="img-fluid logo" src="{{url('frontend/assets/images/logo-hotstar.html')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                     <div class="logo-prime">
                         <a class="navbar-brand text-primary" href="../index.html">
                             <img class="img-fluid logo" src="{{url('frontend/assets/images/logo-prime.html')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                     <div class="logo-hulu">
                         <a class="navbar-brand text-primary" href="../index.html">
                             <img class="img-fluid logo" src="{{url('frontend/assets/images/logo-hulu.html')}}" loading="lazy" alt="streamit" />
                         </a>
                     </div>
                    ...
                    <div class="container-fluid p-lg-0">
                      ...
                      <ul class="navbar-nav iq-nav-menu  list-unstyled" id="header-menu">
                        ...
                        <li class="nav-item">
                          ...
                          <span class="item-name">OTT</span></a>
                        </li>


                         <li class="nav-item">
                          <a class="nav-link" data-bs-toggle="collapse" href="index.html" role="button" aria-expanded="false" aria-controls="homePages">
                          ...
                          <ul class="sub-nav collapse  list-unstyled" id="pages">
                            ...
                            <li class="nav-item">
                              <a class="nav-link " href="{{url('/shows')}}"> TV Shows </a>
                            </li>
                        ...
                        <li class="nav-item">
                          <a class="nav-link" href="index.html">
                          <span class="item-name">Cast</span></a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="index.html">
                          <span class="item-name">About</span></a>
                        </li>
                        <li class="nav-item">
                          <a class="nav-link" href="index.html">
                          <span class="item-name">Contact</span></a>
                        </li>
                      </ul>
                    </div>
                    <!-- container-fluid.// -->
                           ...
                           <li class="nav-item dropdown" id="itemdropdown1">
                              ...
                              <ul class="dropdown-menu dropdown-menu-end dropdown-user border-0 p-0 m-0"
                                 ...
                                 <li class="user-info d-flex align-items-center gap-3 mb-3">
                                    <img src="{{url('frontend/assets/images/user/user1.html')}}" class="img-fluid" alt="" loading="lazy">
