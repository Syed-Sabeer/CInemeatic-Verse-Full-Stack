<footer class="footer footer-default">
        ...
        <div class="row">
          ...
          <div class="col-xl-2 col-lg-6 mb-5 mb-lg-0">
            ...
            <ul class="list-unstyled footer-menu">
              ...
              <li class="mb-3">
                <a href="blog-listing.html" class="ms-3">Blog</a>
              </li>
              <li class="mb-3">
          ...
          <div class="col-md-3">
            ...
            <div class="d-flex align-items-center">
              <a class="app-image" href="#">
                <img src="{{url('frontend/assets/images/footer/google-play.html')}}" loading="lazy" alt="play-store" />
              </a>
              <br />
              <a class="ms-3 app-image" href="#">
                <img src="{{url('frontend/assets/images/footer/apple.html')}}" loading="lazy" alt="app-store" />
              </a>
            </div>
          </div>
        </div>
  ...
  <script src="{{url('frontend/assets/js/core/libs.min.js')}}"></script>
  <script src="{{url('frontend/assets/vendor/lodash/lodash.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/core/external.min.js')}}"></script>
  <script src="{{url('frontend/assets/js/plugins/countdown.js')}}"></script>
  <script src="{{url('frontend/assets/js/utility.js')}}"></script>
  <script src="{{url('frontend/assets/js/setting.js')}}"></script>
  <script src="{{url('frontend/assets/js/setting-init.js')}}" defer></script>
  <script src="{{url('frontend/assets/js/streamit.js')}}" defer></script>
  <script src="{{url('frontend/assets/js/swiper.js')}}" defer></script>
