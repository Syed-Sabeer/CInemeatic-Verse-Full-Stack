   ...
   <section class="section-padding">
       <div class="container-fluid">
           <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-5 row-cols-xl-6">
               <div class="col">
                   <div class="iq-cast">
                     <img src="assets/images/cast/01.html" class="img-fluid" alt="castImg" />
               ...
               <div class="col">
                   <div class="iq-cast">
                     <img src="assets/images/cast/02.html" class="img-fluid" alt="castImg" />
                     <div class="card-img-overlay iq-cast-body">
                       <h6 class="cast-title fw-500">
                         <a href="person-detail.html">
                           Karen
               ...
               <div class="col">
                   <div class="iq-cast">
                     <img src="assets/images/cast/03.html" class="img-fluid" alt="castImg" />
                     <div class="card-img-overlay iq-cast-body">
                       <h6 class="cast-title fw-500">
                         <a href="person-detail.html">
                           James
               ...
               <div class="col">
                   <div class="iq-cast">
                     <img src="assets/images/cast/04.html" class="img-fluid" alt="castImg" />
                     <div class="card-img-overlay iq-cast-body">
                       <h6 class="cast-title fw-500">
                         <a href="person-detail.html">
                           Brenda
               ...
               <div class="col">
                   <div class="iq-cast">
                     <img src="assets/images/cast/05.html" class="img-fluid" alt="castImg" />
                     <div class="card-img-overlay iq-cast-body">
                       <h6 class="cast-title fw-500">
                         <a href="person-detail.html">
                           Mark
               ...
               <div class="col">
                    <div class="iq-cast">
                      <img src="assets/images/cast/06.html" class="img-fluid" alt="castImg" />
                      <div class="card-img-overlay iq-cast-body">
                        <h6 class="cast-title fw-500">
                          <a href="person-detail.html">
                            Caleb
